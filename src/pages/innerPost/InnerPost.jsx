      ...
      <div className="page-name_container container-mega">
         <ul className="page-name_lists">
            <li className="page-name-lists_option">
               <Link href="index.html" className="page-name-link">Home</Link>
            </li>
            <li className="page-name-lists_option">
      ...
      <section className="col-lg-7 inner-main_section">
         <div className="inner-main_container">
            <div className="inner-main_head">
               <h1 className="inner-head_title">How to Spend the Perfect Day on Croatia’s Most Magical Island</h1>
            ...
            <ul className="inner-main_info" id="main-info-inner">
               ...
               <li className="inner-main-info_list">
                  <pre className="inner-main-info_text"><span>comments</span> :  35</pre>
               </li>
               <li className="inner-main-info_list">
                  <pre className="inner-main-info_text"><span>Category</span>:  Sport</pre>
               </li>
            </ul>
         </div>
         <div className="inner-cart_about section container">
            <div className="inner-cart-about_title">
               <h4 className="inner-about_title">Don’t wait. The purpose of our lives is to be happy!</h4>
               <p className="inner-about_subtitle">Upon arrival, your senses will be rewarded with the pleasant scent of
                  lemongrass oil used to clean the
            ...
            <div className="inner-cart-about_title">
               <h4 className="inner-about_title">Not how long, but how well you have lived is the main thing.</h4>
               <p className="inner-about_subtitle">When you are ready to indulge your sense of excitement, check out the
                  range of water- sports opportunities at the resort’s on-site water-sports center. Want to leave your
                  stress on the water? The resort has kayaks, paddleboards, or the low-key pedal boats. Snorkeling
                  equipment is available as well, so you can experience the ever-changing undersea environment.
                  ...
                  partner easily with local businesses for a smoothly organized and highly personalized vacation
                  experience. The Fife and Drum Inn offers options such as the Historic Triangle Package that includes
         ...
         <div className="inner-cart--info container section">
            <div className="inner-cart--sidebar col-lg-6">
               <ul className="inner-sidebar_lists">
                  ...
                  <li className="sidebar-option">
                     <Link to="#form" className="btn btn-small-row reply-btn side-option_btn">
                  ...
                  <div className="post-user_info position-relative">
                     ...
                     <ul className="post-user_desc">
                        ...
                        <li className="post-user_date">
                           <button type="button"
                              className="btn btn-small-row reply-btn btn--red inner-sidebar_btn">Follow</button>
                        </li>
                     </ul>
                  </div>
               </div>
               ...
               <li className="inner-comment_cart sidebar">
                  <div className="inner-comment_user">
                     ...
                     <div className="inner-comment_btn">
                        <button type="button" className="btn btn-small-row reply-btn">Reply</button>
                     </div>
                  </div>
                  <p className="inner-comment">When you are ready to indulge your sense of excitement, check out the range
                     of water- sports opportunities at the resort’s on-site water-sports center. Want to leave your
                     stress on the water? The resort has kayaks, paddleboards, or the low-key pedal boats.</p>
                  <ol className="inner-comment-reply_window">
                     <li className="inner-comment-reply">
                        <div className="comment-reply_user">
                           ...
                           <p className="comment-reply-user_desc inner-comment">a river or a lake island may be called an
                              eyot or ait, and a small island off the coast may be called a holm. Sedimentary islands in
                              the Ganges delta are called chars. A grouping of geographically or geologically related
                              islands, such as the Philippines, is referred to as an archipelago. </p>
                        </div>
                     </li>
                  </ol>
               </li>
               ...
               <div className="inner-cart-form_section">
                  <div className="col-lg-6 inner-cart-form_window">
                     <div className="inner-form_section">
                        <label htmlFor="text" className="inner-form_block">Name </label>
                        <input type="text" placeholder="write name" className="inner-form_input sidebar" />
                     </div>
                     <div className="inner-form_section">
                        <label htmlFor="text" className="inner-form_block">Website </label>
                        <input type="text" placeholder="write website" className="inner-form_input sidebar" />
                     </div>
                     <div className="inner-form_section">
                        <label htmlFor="text" className="inner-form_block">Email </label>
                        <input type="text" placeholder="write email" className="inner-form_input sidebar" />
                     </div>
                  </div>
                  <div className="col-lg-6 inner-form_section">
                     <label htmlFor="text" className="inner-form_block">Comment</label>
                     <textarea name="text" placeholder="write anything"
                        className="inner-form_input input--comment sidebar"></textarea>
                  </div>
               </div>
               <div className="mt-20 inner-cart-footer">
                  <div className="inner-cart_rate col-lg-12 sidebar">
                     <h1 className="inner-cart-rate_title">Rate the usefulness of the article</h1>
                     <div className="inner-cart-rate_reaction">
                        <button type="button" className="inner-rate-reaction btn btn-small-row">
                  ...
                  <div className="inner-cart_btn">
                     <button type="submit" className="btn btn-small-row btn-red send-btn">Send Comment</button>
                  </div>
               </div>
            </form>
         </div>
         <section className="post-main_section section-top">
            <div className="post-main-user">
               ...
               <div className="post-main_body">
                  <div className="post-main_carts slider-block " data-slick="sliders4" data-slick-show="4"
                     data-slick-auto="true" data-slick-auto-speed="1" data-slick-dots="false"
                     data-slick-infinite="false" data-fade="false">

                     <div className="post-main_cart col-lg-3">
                        <div className="post-cart_logo">
                           <img src="assets/images/sport-girl.png" alt="sport-girl.png" className="b-12" />
                        </div>
                        <div className="post-cart_body">
                           <div className="post-cart_text">
                              <Link className="post-cart_title inner-react_title">Opening Day of Boating Season, Seattle WA</Link>
            ...
            <div className="mt-25 sidebar inner-sidebar-tags_section">
               ...
               <ul className="sidebar-tags_lists mt-20">
                  <li className="sidebar-tags_option">
                     ...
                     <ul className="post-user_desc">
                        <li className="post-user_name">How to Spend the Perfect Day on Croatia’s Most Magical Island</li>
