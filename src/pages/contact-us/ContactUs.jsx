    ...
    <MainLayout>
      ...
      <div className="page-name_container container-mega">
         <ul className="page-name_lists">
            ...
            <li className="page-name-lists_option">
               <Link to="contact-us.html" className="page-name-link" aria-disabled="true">Contact Us</Link>
            </li>
         </ul>
      </div>
   </div>
            ...
            <form className="send-post_form mt-4 profile-form">
               <div className="send-post-form_section col-lg-12 edit-form contact-form">
                  <div className="send-form-head_title col-lg-1">
                     <label htmlFor="title" className="send-form-head_text">Subject</label>
                     <input type="text" name="subject" placeholder="write first name"
                        className="send-form-head_input sidebar btn" />
                  </div>
                  <div className="send-form-head_title col-lg-1">
                     <label htmlFor="title" className="send-form-head_text">Name</label>
                     <input type="text" name="name" placeholder="write last name"
                        className="send-form-head_input sidebar btn" />
                  </div>
                  <div className="send-form-head_title col-lg-1">
                     <label htmlFor="title" className="send-form-head_text">Email</label>
                     <input type="email" name="contact_email" placeholder="write email"
                        className="send-form-head_input sidebar btn" />
                  </div>
               </div>
               <div className="col-lg-12 edit-banner-text">
                  <div className="send-post-form_body col-lg-7">
                     ...
                     <div className="send-post-form-body_section sidebar">
                        ...
                        <textarea name="textarea" id="" placeholder="write"
                  ...
                  <div className="send-post-media_head col-lg-2">
                     <label for="title" className="send-form-head_text">add image</label>
               ...
               <div className="profile-save_btn">
                  <button type="submit" className="btn reply-btn btn-small-row btn-red btn-send">Send</button>
               </div>
            </form>
         </div>
      </section>
